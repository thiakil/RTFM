...
public abstract class Manual extends IForgeRegistryEntry.Impl<Manual> {
    /**
     ...
     */
    public abstract void addTab(TabIconRenderer renderer, @Nullable String tooltip, String path);
     ...
     */
    public abstract void addProvider(PathProvider provider);
     ...
     * @param provider the provider to register.
     */
    public abstract void addProvider(ContentProvider provider);
     ...
     * @param provider the provider to register.
     */
    public abstract void addProvider(String prefix, ImageProvider provider);
     ...
     */
    @Nullable
    public abstract String pathFor(ItemStack stack);
     ...
     */
    @Nullable
    public abstract String pathFor(World world, BlockPos pos);
     ...
     */
    @Nullable
    public abstract Iterable<String> contentFor(String path);
     ...
     */
    @Nullable
    public abstract ImageRenderer imageFor(String path);
     ...
     */
    public abstract void openFor(EntityPlayer player);
